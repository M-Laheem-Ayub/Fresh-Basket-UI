...
class ReverseProductList extends StatelessWidget {
  const ReverseProductList({
    super.key,
    ...
    return SizedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final product = selectedCategory[selectedCategory.length - 1 - index];
          return Padding(
                  ...
                  MaterialPageRoute(
                    builder:
                        (context) => ProductDetailScreen(
                          ...
                          index: selectedCategory.length - 1 - index,
                        ),
                  ),
                );
              },
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        setFavorite(
                                          selectedCategory.length - 1 - index,
                                        );
                                      },
                                      child: Icon(
                                        product['favorite']
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Column(
                                  children: [
                                    MyText(text: "Fruit", color: Colors.white),
                                    MyText(
                                      text: product['name'],
                                      color: Colors.white,
